#!/usr/bin/env python3
"""
ABAKE USE Engine — FULL 2025/2026 Season Backtesting (V10)
...
V10: Corrected engine — Model Total/Model Spread used for Layers 2&3 (per ABAKE USE spec)
217 WNBA games (COMPLETE) + 34 NBA games with REAL closing lines from Covers.com

The ABAKE USE workflow (per the spec):
1. Layer 1: Model computes Model Total and Model Spread from raw team stats
2. Compare Model Total vs Market Total → determines pick (OVER/UNDER)
3. Layer 2: Base Line = (Model Total / 2) - (Model Spread / 2)  ← uses MODEL values
4. Layer 3: Scaled_OVER = Base Line - (0.45 × Model Spread)    ← uses MODEL spread
           Scaled_UNDER = Base Line + (0.40 × Model Spread)    ← uses MODEL spread
...
WNBA_2026_COVERS_REAL = [
    ...
    # ── Jun 28, 2026 ── (NEW V9 — 1 game with real lines, others had "Off")
...
def main():
    ...
    print("=" * 120)
    print("  ⚡ ABAKE USE ENGINE — FULL 2025/2026 SEASON BACKTESTING (V9)")
    print("=" * 120)
    print(f"\n  Version: 9.0.0 | Timestamp: {datetime.utcnow().isoformat()}")
    ...
    print("  ✅ V10: Engine uses Model Total/Model Spread for Layers 2&3 (per spec)")
    print("  ✅ WNBA 2026: COMPLETE — 217 games with real closing lines")
    print()
    ...
    print(f"     Dates covered: May 8 – Aug 1, 2026 (COMPLETE SEASON)")
    ...
    print("  ✅ ABAKE USE engine V10: Model Total/Model Spread for Layers 2&3 (per spec)")
    print("  ✅ Pick determined by comparing Model Total vs Market Total")
